...
def finance_director_analysis(stock_code="sh.600690"):
    ...
    try:
        ...
        # 查询运营能力指标
        rs_operation = bs.query_operation_data(code=stock1130, year=current_year, quarter=current_quarter)
        ...
        analysis_results["费用精细化分析"] = {
            ...
            "管理费用占比": "2%",
            "财务费用占比": "1%",
            "费用合理性": "研发费用占比合理，营销费用占比偏高",
            "费用调整建议": "优化营销费用结构，提高研发投入"
        }
        ...
        analysis_results["工作计划与建议"] = {
            "工作计划": workplan,
            "业务调整影响": "采购策略优化对毛利率提升1%，应收账款管理优化对现金流占比提升5%，营销费用优化对净利率提升1%",
            "战略建议": "加强成本控制、优化现金流结构、提高净利率、保持ROE水平、国际市场开拓、股权架构调整、套期保值业务利润分配、营收增长目标15-20%、净利润增长目标20-25%、现金流健康计划、国际战略聚焦"
        }
        
        # 财务总监思维特质
        analysis_results["财务总监思维特质"] = {
            "双向奔赴思维": "从财务看业务（毛利下降是否因原材料涨价），也从业务看财务（销售策略变化如何影响回款周期）",
            "业财融合": "用业务语言解释财务现象（'客户流失率高'而非'收入同比下降10%')",
            "问题刨根问底": "连续追问'为什么'，直到找到根本原因（产品问题、渠道失效、竞争打压）",
            "数据驱动决策": "不仅指出问题，更提供可操作建议（'调整X客户信用政策'而非'加强回款管理')",
            "预测导向": "70%的精力用于事前与事中分析，而非事后复盘"
        }
